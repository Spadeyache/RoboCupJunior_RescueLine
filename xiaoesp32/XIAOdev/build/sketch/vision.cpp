...
FrameResult Vision_Process(camera_fb_t* fb) {
    ...
    // Initialize results
    result.line.detected = false;
    result.line.offset = 0.0;
    result.line.darkPixels = 0;
    result.line.darkPercent = 0.0;

    result.color.r = 0;
    result.color.g = 0;
    result.color.b = 0;
    result.color.isGreen = false;
    result.color.isRed = false;
    result.color.isBlue = false;
    result.color.isWhite = false;
    result.color.isBlack = false;
    ...
    int lineY = (int)(height * LINE_SCAN_ROW);
